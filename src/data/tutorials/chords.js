	...
	return [
		{
			...
			small: `It is the fundamental note on top of which your chord is built, and after which your chord is named. For instance, the chord <strong>${getNoteName(
				0
		...
		},
		{
			...
			small: `This will change the name of the altered notes in the root note list. For instance ${
		...
		},
		{
			...
			small: `This will give you the basic 3-note structure of your chord. For instance picking a <strong>minor</strong> triad over your root note <strong>${getNoteName(
				rootNote,
				useFlats
